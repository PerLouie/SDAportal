...
export default function index() {
  ...
  return (
    <Box>
      ...
      <Paper elevation={3} sx={{ backgroundColor: "#11CBD7", display:"flex"}}>
        <Box sx={{marginLeft:"150px", marginTop:"10px",}}>
          ...
          <Box sx={{display:"flex", marginLeft:"700px"}}>
            ...
            <Typography sx={style.navi} onClick={gotostudSignup}>SignUp</Typography>
            <Typography sx={style.navi} onClick={gotoContact}>Contact</Typography>
      ...
      <Box sx={{ display: "flex", textAlign: "center", marginTop: "20px", backgroundColor:"#F0FFF3" }}>
      ...
      <Box sx={{flexBasis:"50%"}}>
        <Typography sx={{marginTop:"80px", fontSize:"60px"}}>Be Known</Typography>
        <Typography sx={{fontSize:"60px"}}>Be Anything</Typography>
        <Typography sx={{fontSize:"60px"}}>Be The Best You Can Be</Typography>
        <Button variant="contained" sx={{marginTop:"10px", color:"white", backgroundColor:"red"}} onClick={gotoContact}>Inquire Now</Button>
      </Box>
      </Box>
    </Box>
  );
